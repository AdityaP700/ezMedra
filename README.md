...
- Demo-only master faculty seed script available for IT department review queues
...
- backend/scripts/seedMasterFaculty.js
...
- Live attendance summary with risk indicator, badges, and leave impact preview
- Working day and holiday-aware warning messages
- Extra-session and bonus-credit insight fields
- The detailed attendance prediction card is currently disabled in the UI and kept as a commented component for reference
...
Optional IT demo review account generated by backend/scripts/seedMasterFaculty.js:

- Master Faculty: master.faculty@slms.com / faculty123

This account is assigned across IT department subject/section mappings and is useful for loading the pending leave review queue immediately in demo environments.
